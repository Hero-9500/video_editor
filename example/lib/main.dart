              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    buildSplashTap("4:3", 4 / 3,
                        padding: Margin.horizontal(15),
                        iconData: FontAwesomeIcons.youtube),
                    buildSplashTap("1:1", 1 / 1,
                        padding: Margin.horizontal(15),
                        iconData: FontAwesomeIcons.pinterestSquare),
                    SizedBox(
                      width: 10,
                    ),
                    buildSplashTap("Random", null,
                        padding: Margin.right(15),
                    ...
                    SplashTap(
                      ...
                      child: Center(
                        child:
                            TextDesigned("OK", color: Colors.white, bold: true),
                      ),
                    ),
                  ],
                ),
